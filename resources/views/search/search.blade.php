        ...
        <form method="GET" action="{{ route('buscar_profesor.indexUser') }}">
            <div class="container bg-primary text-black py-4">
                <div class="form-group">
                    ...
                    <hr>
                    <h3 class="text-secondary text-center font-weight-bold"> Datos exclusivos de profesores de profesor </h3>
            ...
            <ul class="list-group">
                @forelse ($users_list as $usuario)
                    <li class="list-group-item list-group-item-light list-group-item-action">
                        ...
                        <hr>
                        <div class="text-center">
                            <a class="btn btn-outline-secondary btn-sm mr-5" href="#">
                                Editar datos de usuario 
                                {{-- falta agregar esta vista de editar datos usuario --}}
                            </a>
