                        ...
                        <div class="form-group form-row">
                                <div class="col-md-4">  
                                        ...
                                        <input type="email" name="email_personal" id="email_personal" class="form-control" placeholder="Email personal" 
                                                value="{{ old('email_personal', session()->get('curriculum.email_personal')) }}">
                                </div>
                                <div class="col-md-4">  
