    ...
    <nav class="navbar navbar-dark navbar-expand-lg shadow-sm" style="background-color: rgba(11, 81, 187, 0.548)">
        <ul class="nav nav-pills nav-fill justify-content-center">
            <li class="nav-item">
                ...
                class="nav-link {{ $formNum == 1 ? 'active' : ''}}">
                    ...
                    @if (session()->get('completedList') && session()->get('completedList')['form1'])
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-check" fill="rgb(125, 255, 136)" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @else
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-exclamation-fll" fill="rgba(255, 0, 0, 0.877)" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-question-diamond" fill="rgba(236, 119, 221, 0.877)" xmlns="http://www.w3.org/2000/svg">
